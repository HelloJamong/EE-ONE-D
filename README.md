...
# .env.example 다운로드
curl -L https://github.com/HelloJamong/EE-ONE-D/releases/latest/download/default.env.example -o .env.example
```
...
curl -L https://github.com/HelloJamong/EE-ONE-D/releases/download/${VERSION}/default.env.example -o .env.example
```
